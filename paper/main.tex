...
% space.
% Required citations: brandes2023, landrum2018clinvar (already in this section)
...
% Required citations: TBD — add to shared/bib/references.bib (DOI-pinned) before citing.
...
%   evaluation.metrics.{llr_auroc, llr_auroc_ci95_bootstrap}
%   evaluation.literature_anchor.{llr_auroc, n, reference}
% Required figure: resolution_panels (already \includegraphics'd below)
% Required PROVENANCE entry: "Resolution panels (slide: Part 2 'Resolution')"
...
% encountered, (d) honest limitations.
% Required citations: brandes2023
% Required values from experiments/notebooks/data/workshop_set_manifest.json:
%   evaluation.metrics.llr_auroc            (must match §Results)
%   evaluation.literature_anchor.{inside_workshop_ci95, note}
%   universe_filters.variant_type           (SNPs only, no indels)
%   composition.{unique_genes, singleton_genes}   (400 genes; 338/400 singletons)
% Reference: experiments/EXPERIMENT_LOG.md
%   2026-05-13 (Brandes-correct LLR + sign-fix scar)
%   2026-05-12 (MAX_LEN off-by-2 — crashed on BRCA1 L1854P, the demo pair)
